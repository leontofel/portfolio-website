...
<h3>Nossos diferenciais:</h3>
                ...
                <ul>
                    <li>
                        ...
                        <p>Leque grande de tecnologias</p>
                        <hr/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>Acerta as necessidades do cliente</p>
                        <hr/>
                    </li>
                    <li>
                        ...
                        <p>Profissionais qualificados e certificados</p>
                        <hr/>
                    </li>
                    <li>
                        ...
                        <p>A estratégia certa para o seu negócio</p>
                        <hr/>
                    </li>
                    <li>
